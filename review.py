...
browser.get(
    'https://www.google.com/maps/place/Embassy+Manyata+Business+Park/@13.0499862,77.6175589,17z/data=!3m1!4b1!4m10!1m2!2m1!1smanyata+tech+park+banglore!3m6!1s0x3bae176ddc662065:0x57b2874f9023bb8!8m2!3d13.049981!4d77.6197476!9m1!1b1')
...
for a in mydivs:
    textdoc.write(
        str("\nReviewer name: " + a.find("div" , class_="section-review-title").text) + " \n||Reviewer Detail: " + str(
            a.find("div" , class_="section-review-subtitle").text) + " \n||Reviewerer Profile URL:" + str(
            a.find("a").get('href')))
